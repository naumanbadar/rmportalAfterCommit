...
/**
 * The async counterpart of <code>SchedulerService</code> that is called from
...
public interface ResourceManagerServiceAsync {
	 ...
	 * 
	 * @param user
	 *            the object that is used for login
	 * @param callback
	 *            the object used for notifying the caller when the asynchronous
	 *            call completes.
	...
	/**
	 * Method used for making asynchronous calls to the server for retrieving
	 ...
	 */
	// void getJobs(String sessionId, AsyncCallback<JobBag> callback) throws
	// GettingJobException;

	/**
	 * Method used for making asynchronous calls to the server for returning the
	...
	void getMonitoredEventsFromRestService(String sessionId, AsyncCallback<MonitoredEvents> callback);
}
